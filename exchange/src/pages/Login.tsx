      ...
      <div className="w-full max-w-md">
        <div className="bg-[#0f1319] border border-[#1a1f2e] rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-[#5a6478] mt-2">به صراف اکسچنج خوش آمدید</p>
          </div>
          ...
          <div className="text-center mt-6">
            <span className="text-[#5a6478] text-sm">حساب ندارید؟ </span>
            <Link to="/signup" className="text-[#00d4aa] hover:underline text-sm font-medium">ثبت نام کنید</Link>
          </div>
        </div>
      </div>
    </div>
